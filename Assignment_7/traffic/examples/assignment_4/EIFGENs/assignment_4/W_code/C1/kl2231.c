...
extern EIF_TYPED_VALUE F2231_30235(EIF_REFERENCE);
...
RTOID (F2231_30235)
EIF_TYPED_VALUE F2231_30235 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 2230, Current, 0, 0, 35025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2230, Current, 35025);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
