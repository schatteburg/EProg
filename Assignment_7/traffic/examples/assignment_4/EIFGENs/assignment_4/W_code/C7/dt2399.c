/*
 * Code for class DT_UTC_SYSTEM_CLOCK
 */
...
extern void F2399_34302(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2399_34303(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2399_34304(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {DT_UTC_SYSTEM_CLOCK}.set_time_to_now */
void F2399_34302 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_4 ui4_4x.it_i4
	...
	RTEAA(l_feature_name, 2398, Current, 0, 1, 39377);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2398, Current, 39377);
	if (arg1) {
		RTCC(arg1, 2398, l_feature_name, 1, eif_new_type(2377, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(23736, dtype))(Current);
	RTHOOK(3);
...
/* {DT_UTC_SYSTEM_CLOCK}.set_date_to_now */
void F2399_34303 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_3 ui4_3x.it_i4
	...
	RTEAA(l_feature_name, 2398, Current, 0, 1, 39378);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2398, Current, 39378);
	if (arg1) {
		RTCC(arg1, 2398, l_feature_name, 1, eif_new_type(2380, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {DT_UTC_SYSTEM_CLOCK}.set_date_time_to_now */
void F2399_34304 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_4 ui4_4x.it_i4
	...
	RTEAA(l_feature_name, 2398, Current, 0, 1, 39379);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2398, Current, 39379);
	if (arg1) {
		RTCC(arg1, 2398, l_feature_name, 1, eif_new_type(2383, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
