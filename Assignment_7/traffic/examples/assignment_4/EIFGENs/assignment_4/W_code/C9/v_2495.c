/*
 * Code for class V_TABLE_ITERATOR [G#1, G#2]
 */
...
extern EIF_TYPED_VALUE F2495_30778(EIF_REFERENCE);
extern void F2495_34561(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F2495_30778 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 2494, Current, 0, 0, 35759);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(2494, Current, 35759);
	RTIV(Current, RTAL);
	RTHOOK(1);
