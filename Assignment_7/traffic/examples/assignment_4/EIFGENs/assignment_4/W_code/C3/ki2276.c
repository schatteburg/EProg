...
extern EIF_TYPED_VALUE F2276_30901(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F2276_30901 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 2275, Current, 0, 1, 35922);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2275, Current, 35922);
	if (arg1) {
		RTCC(arg1, 2275, l_feature_name, 1, eif_new_type(915, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
