...
extern EIF_TYPED_VALUE F2348_32361(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2348_32361 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 2347, Current, 0, 0, 37439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2347, Current, 37439);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF800092B, 0,0); /* Result */
