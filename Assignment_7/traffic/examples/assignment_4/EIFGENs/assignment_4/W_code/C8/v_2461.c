...
extern void F2461_30360(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2461_30361(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F2461_30360 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2460, Current, 0, 1, 35119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2460, Current, 35119);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {2457,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
			...
			RTCC(arg1, 2460, l_feature_name, 1, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
...
body:;
	for (;;) {
		...
		if (tb1) break;
		RTHOOK(4);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(23911, "item", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(24031, dtype))(Current, ur1x);
		RTHOOK(5);
...
void F2461_30361 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2460, Current, 1, 2, 35120);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2460, Current, 35120);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {2457,0,0,0xFFFF};
			EIF_TYPE typres0;
