/*
 * Code for class V_IO_ITERATOR [INTEGER_32]
 */
...
extern void F2448_30771(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {V_IO_ITERATOR}.output */
void F2448_30771 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 2447, Current, 0, 1, 35751);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2447, Current, 35751);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(2);
	ui4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(24370, dtype))(Current, ui4_1x);
	RTHOOK(3);
