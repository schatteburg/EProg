/*
 * Code for class V_IO_ITERATOR [G#1]
 */
...
extern void F2460_30771(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F2460_30771 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2459, Current, 0, 1, 35752);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2459, Current, 35752);
	RTCC(arg1, 2459, l_feature_name, 1, RTWCT(23917, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(2);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(24370, dtype))(Current, ur1x);
	RTHOOK(3);
