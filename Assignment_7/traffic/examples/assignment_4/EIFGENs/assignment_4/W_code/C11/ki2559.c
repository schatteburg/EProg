...
extern EIF_TYPED_VALUE F2559_30308(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2559_30309(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2559_30311(EIF_REFERENCE);
extern void F2559_30316(EIF_REFERENCE);
extern void F2559_30317(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2559_30308 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 2558, Current, 2, 3, 35088);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2558, Current, 35088);
	if (arg1) {
		{
			static EIF_TYPE_INDEX typarr0[] = {2557,0,0,0xFFFF};
			EIF_TYPE typres0;
			{
				EIF_TYPE l_type;
			...
			RTCC(arg1, 2558, l_feature_name, 1, typres0, 0x00);
		}
	}
	RTIV(Current, RTAL);
...
body:;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN) !tb1) {
			...
			uc1 = tc1;
			ui4_1 = loc1;
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(23889, "put", arg1))(arg1, uc1x, ui4_1x);
			RTHOOK(13);
			RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
			loc1++;
		} else {
...
EIF_TYPED_VALUE F2559_30309 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2558, Current, 0, 0, 35089);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2558, Current, 35089);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F2559_30311 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2558, Current, 0, 0, 35090);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2558, Current, 35090);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
...
void F2559_30316 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2558, Current, 0, 0, 35091);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2558, Current, 35091);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2559_30317 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2558, Current, 0, 0, 35092);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2558, Current, 35092);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
