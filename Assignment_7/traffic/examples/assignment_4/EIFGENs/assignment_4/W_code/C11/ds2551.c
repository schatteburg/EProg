/*
 * Code for class DS_BILINEAR_TABLE [G#1, G#2]
 */
...
extern EIF_TYPED_VALUE F2551_32505(EIF_REFERENCE);
extern void EIF_Minit2551(void);
...
EIF_TYPED_VALUE F2551_32505 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2550, Current, 0, 0, 37657);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2550, Current, 37657);
	RTIV(Current, RTAL);
