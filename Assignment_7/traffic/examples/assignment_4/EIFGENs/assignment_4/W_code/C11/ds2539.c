/*
 * Code for class DS_BILINEAR_TABLE [BOOLEAN, G#2]
 */
...
extern EIF_TYPED_VALUE F2539_32505(EIF_REFERENCE);
...
EIF_TYPED_VALUE F2539_32505 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2538, Current, 0, 0, 37656);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2538, Current, 37656);
	RTIV(Current, RTAL);
