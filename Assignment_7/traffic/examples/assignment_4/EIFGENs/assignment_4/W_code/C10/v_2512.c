/*
 * Code for class V_CELL_CURSOR [G#1]
 */
...
extern EIF_TYPED_VALUE F2512_30142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2512_30143(EIF_REFERENCE);
extern void F2512_30144(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2512_30147(EIF_REFERENCE);
extern void F2512_34534(EIF_REFERENCE, int);
...
/* {V_CELL_CURSOR}.item */
EIF_TYPED_VALUE F2512_30142 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 2511, Current, 0, 0, 34926);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2511, Current, 34926);
	RTIV(Current, RTAL);
...
/* {V_CELL_CURSOR}.off */
EIF_TYPED_VALUE F2512_30143 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 2511, Current, 0, 0, 34927);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2511, Current, 34927);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (!(EIF_BOOLEAN)(tr1 == NULL)) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(23833, dtype))(Current)).it_b);
		tb1 = (EIF_BOOLEAN) !tb2;
	}
...
/* {V_CELL_CURSOR}.box */
EIF_TYPED_VALUE F2512_30147 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 2511, Current, 0, 0, 34929);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2511, Current, 34929);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(23830, dtype))(Current)).it_b);
	if (tb1) {
		...
		RTDBGAL(Current, 0, 0xF8000978, 0,0); /* Result */
		{
			...
			{
				EIF_TYPE l_type;
				l_type = RTWCT(23835, dtype, dftype);
		...
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(23829, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr2);
...
/* {V_CELL_CURSOR}._invariant */
void F2512_34534 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 2511, Current, 0, 34533);
	RTSA(dtype);
	RTME(dtype, 0);
